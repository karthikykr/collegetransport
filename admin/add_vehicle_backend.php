<?php 
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $query="INSERT INTO `add_vehicle`(`vehicle_type`,`v_reg_no`,`v_insurance_no`,`v_insurance_valid`,`v_emission_valid`)VALUES('$vehicle_type','$v_regno','$v_insurance_no','$insurance_valid','$emission_valid')";
